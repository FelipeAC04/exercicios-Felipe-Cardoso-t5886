...
*/
     //sim havera um erro, o console.log(mensagem) nao consegue encontrar a variavel mensagem porque ela esta incluida dentro do if.
...
if(idade >= 18) {console.log(`Pode dirigir, é maior de idade!`)} else {`Não pode dirigir, é menor de idade!`}
